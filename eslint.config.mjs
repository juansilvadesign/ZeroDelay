...
export default [
    ...
    // Classic scripts in the page (MAIN) world — not ES modules. The engine/
    // modules are ALSO loaded as CommonJS in Node/tests, so they legitimately
    // touch `module`/`exports`; those globals are harmless for inject.js,
    // which ignores them.
    {
