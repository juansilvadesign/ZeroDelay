...
test('syncedKeys roam the preference-class keys and nothing device-local', () => {
    ...
    // double-count, the go-live nonce is transient, and currentChannelId is
    // literally "this device's tab".
    for (const k of [...common.donateKeys, common.goLiveSignalKey, common.currentChannelIdKey]) {
